...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebSource.url_processor'
        db.add_column('scraping_websource', 'url_processor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebSource.url_processor'
        db.delete_column('scraping_websource', 'url_processor')
    ...
    models = {
        ...
        'scraping.websource': {
            ...
            'url_processor': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
